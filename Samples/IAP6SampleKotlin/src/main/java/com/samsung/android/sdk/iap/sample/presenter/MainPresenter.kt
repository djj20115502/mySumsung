...
class MainPresenter(private val view: MainContract.View) : MainContract.Presenter {
    ...
    private var isInfiniteBullet: Boolean = false
    ...
    override fun purchaseItem(itemId: ItemID) {
        if ((itemId == ItemID.CONSUMABLE) && (bulletCount >= 5 || isInfiniteBullet)) {
    ...
    override fun saveGunBulletStatus() {
        itemRepository.setPreference(GunBulletData(bulletCount, gunLevel.level, isInfiniteBullet))
    }
}